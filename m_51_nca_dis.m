...
writematrix(data, 'heat_generation_NCA_discharge_.csv');
disp('Heat generation per cell during discharge saved to heat_generation_nca_discharge_.csv');
...
writematrix(soc_data, 'soc_vs_time_NCA_discharging.csv');
disp('SOC vs time');
